...
public:
    ...
    //ctre::phoenix::motorcontrol::can::TalonFX conveyorMotor{4};

    // Run in Init
    void Initiate();
    // Run in Periodic
    void updateBreakBeams(bool newBallBreakBeambool, bool indexBreakBeam, bool conveyorStartBreakBeam, bool intakeFullBreakBeam, bool conveyorSpaceBreakBeam);
    void updateButtons();
